var Bird = function(scene, octree, obstacles, velocity_hash, position, orientation,id) {
	...
	this.vectorDatos = new Array([6,3,0x00f91d],[8,3,0x00f9e6],[8,9,0x0004f9],[4,8,0xf90000],[4,125.568,0x000000],[14,124.62,0x7e7e7e],[0,116.901,0xf600ec],[11,119.598,0xf0ff00]);
...
//Metodo de la clase ver si 
Bird.prototype.calcular_ranking = function(vector, min, max) {
	if (vector.length() > max) {
		vector.normalize();
		vector.multiplyScalar(max);
	}
...
Bird.prototype.update_position = function(elapsed_time, lookAt) {
	...
	console.log(this.id,this.velocity.length(),displacement.length());
	//console.log(this.vectorDatos[0][0]);
